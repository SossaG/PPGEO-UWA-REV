...
class VMamba(nn.Module):
    def __init__(
        ...
        self.vision_model = VSSM(
                ...
                downsample_version=downsample_version, # "v1", "v2", "v3"
                patchembed_version=patchembed_version, # "v1", "v2"
...
if __name__ == "__main__":
    ...
    model_path_name = "VMamba_shuttle_lane_following_13_0.0004_0.8094_0.8205.pth"
    checkpoint = None
