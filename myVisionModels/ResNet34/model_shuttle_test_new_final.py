...
if __name__ == "__main__":
    ...
    parser.add_argument("model_name", default="checkpoints_new_final/imagenet_frozen_lane_following_finetune_0.01/ResNet34_shuttle_imagenet_frozen_lane_following_finetune_0.01_3_0.0036_0.1190_0.1562.pth", type=str, nargs='?')
