...
if __name__ == "__main__":
    ...
    def _reload_model_from_path(pt_model_path: str):
        """Reload a PPGeoNavModelGray from a given checkpoint path."""
        m = build_model_for_eglinton_gray(
    ...
    def _last_conv_before_gap_or_fallback(model: nn.Module) -> nn.Module:
        ...
        # PPGeoNavModelGray → encoder is ResNet-34; GAP is applied after layer4
        try:
